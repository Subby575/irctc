      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600">
            Join RailBook to start booking train tickets
          </p>
        </div>
            ...
            <div>
              ...
              <div className="mt-1 relative">
                <input
                  ...
                  } placeholder-gray-500 text-gray-900 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 pr-10`}
              ...
              <div className="mt-2">
                <div className="text-xs text-gray-500">
                  ...
                  <ul className="mt-1 space-y-1">
                    <li className={`flex items-center ${form.password.length >= 8 ? 'text-green-600' : 'text-gray-400'}`}>
                      <svg className="h-3 w-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                      </svg>
                      At least 8 characters
                    </li>
                    <li className={`flex items-center ${/(?=.*[a-z])(?=.*[A-Z])(?=.*\d)/.test(form.password) ? 'text-green-600' : 'text-gray-400'}`}>
                      <svg className="h-3 w-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                      </svg>
        ...
        <div className="text-center">
          <p className="text-xs text-gray-500">
            By creating an account, you're joining thousands of users who trust RailBook for their train booking needs.
          </p>
        </div>
      </div>
    </div>
